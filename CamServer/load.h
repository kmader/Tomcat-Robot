...
int (__stdcall *GetNoiseFilterMode)(HANDLE ph,WORD *wNoiseFilterMode);
int (__stdcall *SetNoiseFilterMode)(HANDLE ph,WORD wNoiseFilterMode);
...
int (__stdcall *GetBuffer)(HANDLE ph,SHORT sBufNr,WORD **wBuf,HANDLE *hEvent);
int (__stdcall *WaitforBuffer)(HANDLE ph, int nr_of_buffer, PCO_Buflist *bl, int timeout);
